...
id BIGINT(11) PRIMARY KEY (id) NOT NULL AUTO_INCREMENT,
sn VARCHAR(15) NOT NULL COMMENT '基站序列号',
imsi VARCHAR(20) NOT NULL COMMENT '手机imsi号',
...
imei VARCHAR(20) NOT NULL COMMENT '手机的IMEI号',
...
standard VARCHAR(20) DEFAULT NULL COMMENT '运营商制式',
time datetime DEFAULT NULL COMMENT '时间',
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT 'IMSI码总表'