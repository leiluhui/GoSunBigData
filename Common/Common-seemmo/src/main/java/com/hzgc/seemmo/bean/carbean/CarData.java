...
public class CarData {
    ...
    public static final String MISTAKE_CODE = "mistake_code";
    ...
    public static final String PLATE_COLER_CODE = "plate_color_code";
    ...
    public static final String SPARETIRE_CODE = "sparetire_code";
