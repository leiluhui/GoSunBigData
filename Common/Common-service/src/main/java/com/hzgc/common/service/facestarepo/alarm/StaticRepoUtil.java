package com.hzgc.common.service.facestarepo.alarm;

import com.hzgc.common.service.facestarepo.table.ObjectInfoTable;
...
class StaticRepoThread implements Runnable {
    ...
    StaticRepoThread(StaticRepoUtil handler, String kafkaBootStrap) {
    ...
    private void addObject(String event) {
        StaticRepoObject object = JacksonUtil.toObject(event, StaticRepoObject.class);
...
public class StaticRepoUtil implements Serializable {
     ...
     * @return 返回实例化对象
     */
    public static StaticRepoUtil getInstance(String kafkaBootStrap, String jdbcUrl) {
        if (instance == null) {
            synchronized (StaticRepoUtil.class) {
                if (instance == null) {
                    instance = new StaticRepoUtil(kafkaBootStrap, jdbcUrl);
                }
            }
        }
        return instance;
