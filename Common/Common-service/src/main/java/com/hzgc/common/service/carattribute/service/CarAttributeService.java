...
public class CarAttributeService {
    ...
    public List<CarAttribute> getCarAttribute() {
        ...
        for (Integer key : plate_type_code.keySet()) {
            ...
            plateTypeCodeValue.setValue(String.valueOf(key));
        ...
        for (Integer key : plate_color_code.keySet()) {
            ...
            plateColorCodeValue.setValue(String.valueOf(key));
        ...
        for (Integer key : plate_flag_code.keySet()) {
            ...
            plateFlagCodeValue.setValue(String.valueOf(key));
        ...
        vehicleColor.setIdentify(CarData.VEHICLE_COLOR);
        ...
        for (Integer key : vehicle_color.keySet()) {
            ...
            vehicleColorValue.setValue(String.valueOf(key));
        ...
        vehicleType.setIdentify(CarData.VEHICLE_TYPE);
        ...
        for (Integer key : vehicle_type.keySet()) {
            ...
            vehicleTypeValue.setValue(String.valueOf(key));
        ...
        for (Integer key : belt_maindriver_code.keySet()) {
            ...
            belt_maindriverCodeValue.setValue(String.valueOf(key));
        ...
        for (Integer key : belt_codriver_code.keySet()) {
            ...
            belt_codriverCodeValue.setValue(String.valueOf(key));
        ...
        for (Integer key : call_code.keySet()) {
            ...
            callCodeValue.setValue(String.valueOf(key));
        ...
        for (Integer key : crash_code.keySet()) {
            ...
            crashCodeValue.setValue(String.valueOf(key));
        ...
        for (Integer key : danger_code.keySet()) {
            ...
            dangerCodeValue.setValue(String.valueOf(key));
        ...
        for (Integer key : plate_schelter_code.keySet()) {
            ...
            plateSchelterCodeValue.setValue(String.valueOf(key));
        ...
        plateDestainCode.setIdentify(CarData.PLATE_DESTAIN_CODE);
        ...
        for (Integer key : plate_destain_code.keySet()) {
            ...
            plateDestainCodeValue.setValue(String.valueOf(key));
        ...
        rackCode.setIdentify(CarData.RACK_CODE);
        ...
        for (Integer key : rack_code.keySet()) {
            ...
            rackCodeValue.setValue(String.valueOf(key));
