...
## Filename:    start-discover-job.sh
## Description: to start discover(启动查找任务)
## Author:      chenke
## Created:     2018-08-23
################################################################################
...
LOG_FILE=${SPARK_LOG_DIR}/discover.log
######## common目录 ########
...
## spark class
SPARK_CLASS_PARAM=com.hzgc.cluster.spark.clustering.Discover
