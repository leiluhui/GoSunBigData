...
public class RocketMQProducer implements Serializable {
    ...
    private RocketMQProducer(){
        defaultMQProducer = new DefaultMQProducer(CollectProperties.getRokcetmqCaptureGroup());
        defaultMQProducer.setRetryTimesWhenSendFailed(4);
        defaultMQProducer.setRetryAnotherBrokerWhenNotStoreOK(true);
        defaultMQProducer.setNamesrvAddr(CollectProperties.getRocketmqAddress());
        try {
