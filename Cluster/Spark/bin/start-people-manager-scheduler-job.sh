...
LOG_FILE=${SPARK_LOG_DIR}/peopleManagerScheduler.log
######## common目录 ########
...
## spark class
SPARK_CLASS_PARAM=com.hzgc.cluster.spark.clustering.PeopleManagerScheduler
...
${SPARK_LIB_DIR}/common-zookeeper-1.0.jar,\
